...
def WEB_RESPONSECODE_SERVER_COUNT(servername, response, startingdate):
...
def list_web_responsecode_server_count(servername, response, startingdate):
        WEB_R = WEB_RESPONSECODE_SERVER_COUNT(servername, response, startingdate)
        return WEB_R
