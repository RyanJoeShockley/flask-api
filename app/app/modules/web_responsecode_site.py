...
def WEB_RESPONSECODE_SITE(host, response, num, startingdate):
...
def list_web_responsecode_site(host, response, num, startingdate):
        WEB_Resp = WEB_RESPONSECODE_SITE(host, response, num, startingdate)
        return WEB_Resp